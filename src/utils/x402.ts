...
//   5. /mcp is the A2MCP transport endpoint and is FREE (marketplace
//      wraps it in its own x402 layer). The /v1/* endpoints are the
//      pay-per-call x402 endpoints (for direct API users).
